...
#ifndef INCLUDE_DOPE_VECTOR_INTERNAL_INLINES_EXPRESSION_HPP_
#define INCLUDE_DOPE_VECTOR_INTERNAL_INLINES_EXPRESSION_HPP_
...
template <class E, typename T, SizeType Dimension, typename Op>
inline StaticArrayUnaryExpression<E, T, Dimension,
                                  Op>::StaticArrayUnaryExpression(const E &e)
    : _e(e) {}

template <class E, typename T, SizeType Dimension, typename Op>
inline T StaticArrayUnaryExpression<E, T, Dimension, Op>::operator[](
...
template <class El, class Er, typename T, SizeType Dimension, typename Op>
inline StaticArrayBinaryExpression<
    El, Er, T, Dimension, Op>::StaticArrayBinaryExpression(const El &el,
                                                           const Er &er)
    : _el(el), _er(er) {}

template <class El, class Er, typename T, SizeType Dimension, typename Op>
inline T StaticArrayBinaryExpression<El, Er, T, Dimension, Op>::operator[](
    const SizeType i) const {
  if (!_values[i]) {
...
operator+(const StaticArrayExpression<El, T, Dimension> &el,
  ...
  return StaticArrayBinaryExpression<El, Er, T, Dimension, std::plus<T>>(el,
                                                                         er);
}
...
operator-(const StaticArrayExpression<El, T, Dimension> &el,
          const StaticArrayExpression<Er, T, Dimension> &er) {
  return StaticArrayBinaryExpression<El, Er, T, Dimension, std::minus<T>>(el,
                                                                          er);
}
...
operator*(const StaticArrayExpression<El, T, Dimension> &el,
          const StaticArrayExpression<Er, T, Dimension> &er) {
  return StaticArrayBinaryExpression<El, Er, T, Dimension, std::multiplies<T>>(
      el, er);
}
...
operator/(const StaticArrayExpression<El, T, Dimension> &el,
          const StaticArrayExpression<Er, T, Dimension> &er) {
  return StaticArrayBinaryExpression<El, Er, T, Dimension, std::divides<T>>(el,
                                                                            er);
}
...
operator%(const StaticArrayExpression<El, T, Dimension> &el,
          const StaticArrayExpression<Er, T, Dimension> &er) {
  return StaticArrayBinaryExpression<El, Er, T, Dimension, std::modulus<T>>(el,
                                                                            er);
}
...
#endif  // INCLUDE_DOPE_VECTOR_INTERNAL_INLINES_EXPRESSION_HPP_
