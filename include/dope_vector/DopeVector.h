...
class DopeVector {
 public:
   ...
   */
  inline explicit DopeVector(T *array, const SizeType accumulatedOffset,
                             const IndexD &size);
   ...
   */
  inline explicit DopeVector(T *array, const SizeType accumulatedOffset,
                             const IndexD &size, const IndexD &offset);
   ...
   *    @param size               Sizes of the D-dimensional matrix.
   */
  inline void reset(T *array, const SizeType accumulatedOffset,
                    const IndexD &size);
   ...
   *                              dimension.
   */
  inline void slice(const SizeType d, const SizeType i,
                    DopeVector<T, Dimension - 1> &s) const;
   ...
   */
  inline DopeVector<T, Dimension - 1> slice(const SizeType d,
   ...
   */
  inline void window(const IndexD &start, const IndexD &size,
                     DopeVector &w) const;
   ...
   */
  inline SizeType accumulatedOffset(const SizeType i,
                                    const SizeType d = 0) const;
 ...
 private:
  ...
  SizeType _accumulatedOffset;  ///< Offset of the first element of this matrix
                                ///< from the beginning of the stored array.
  IndexD _size;                 ///< Sizes of this matrix, for each dimension.
  IndexD _offset;  ///< Jumps' offsets from the beginning of a "row" to the
                   ///< beginning of the next one, for each dimension.
};
...
class DopeVector<T, 1> {
 public:
   ...
   */
  inline DopeVector(T *array, const SizeType accumulatedOffset,
                    const SizeType size);
   ...
   */
  inline void window(const Index1 &start, const Index1 &size,
   ...
   *    @param w                  The output sub-vector.
   */
  inline void window(const SizeType start, const SizeType size,
                     DopeVector<T, 1> &w) const;
   ...
   *    @return The output sub-vector.
   */
  inline DopeVector<T, 1> window(const SizeType start,
 ...
 private:
  ...
  SizeType _accumulatedOffset;  ///< Offset of the first element of this vector
                                ///< from the beginning of the stored array.
  Index1 _size;                 ///< Sizes of this matrix, for each dimension.
  Index1 _offset;  ///< Jumps' offsets from the beginning of a "row" to the
                   ///< beginning of the next one, for each dimension.
};
