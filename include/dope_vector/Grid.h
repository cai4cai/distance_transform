...
#ifndef INCLUDE_DOPE_VECTOR_GRID_H_
#define INCLUDE_DOPE_VECTOR_GRID_H_
...
class Grid : public DopeVector<T, Dimension> {
 public:
   ...
   *                              elements.
   */
  inline explicit Grid(const IndexD &size, const IndexD &order,
   ...
   *                              elements.
   */
  inline explicit Grid(const SizeType size, const IndexD &order,
                       const T &default_value = T());
   ...
   *          conservativeResize.
   */
  inline void resize(const IndexD &size, const IndexD &order,
                     const T &default_value = T());
   ...
   *          conservativeResize.
   */
  inline void resize(const SizeType size, const IndexD &order,
                     const T &default_value = T());
   ...
   *                              elements.
   */
  inline void assign(const IndexD &size, const IndexD &order,
   ...
   *                              elements.
   */
  inline void assign(const SizeType size, const IndexD &order,
                     const T &default_value);
   ...
   */
  inline void conservativeResize(const IndexD &size,
                                 const T &default_value = T());
   ...
   *          copied. See resize for faster resizing.
   */
  inline void conservativeResize(const IndexD &size, const IndexD &order,
                                 const T &default_value = T());
   ...
   *          copied. See resize for faster resizing.
   */
  inline void conservativeResize(const SizeType size,
                                 const T &default_value = T());
   ...
   *          copied. See resize for faster resizing.
   */
  inline void conservativeResize(const SizeType size, const IndexD &order,
                                 const T &default_value = T());
...
#endif  // INCLUDE_DOPE_VECTOR_GRID_H_
