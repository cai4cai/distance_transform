...
struct SizeTypesCheck {
  static constexpr bool value =
      (std::is_arithmetic<T>::value) && (SizeTypesCheck<Rest...>::value);
};
...
class Index : public std::array<SizeType, Dimension>,
              public internal::StaticArrayExpression<Index<Dimension>, SizeType,
                                                     Dimension> {
 public:
  ////////////////////////////////////////////////////////////////////////
  // CONSTRUCTORS
  ...
  template <typename... Sizes,
            class = typename std::enable_if<
                internal::SizeTypesCheck<SizeType, Sizes...>::value>::type>
   ...
   * @warning This operator is not Eigen compatible. In case of using Eigen,
   * please use cwiseProduct.
   */
  template <class E>
  inline Index &operator*=(
      const internal::StaticArrayExpression<E, SizeType, Dimension> &e);
 ...
 */
template <SizeType Dimension>
static inline SizeType to_position(const Index<Dimension> &index,
 ...
 */
template <SizeType Dimension>
static inline SizeType to_positionFromOffset(const Index<Dimension> &index,
 ...
 */
template <SizeType Dimension>
static inline Index<Dimension> to_index(const SizeType position,
                                        const Index<Dimension> &range);
 ...
 */
template <SizeType Dimension>
static inline Index<Dimension> to_indexFromOffset(
    const SizeType position, const Index<Dimension> &offset);
